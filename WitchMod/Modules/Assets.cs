...
namespace WitchMod.Modules
{
	internal static class Assets
	{
		...
		// CHANGE THIS
		private const string assetbundleName = "witchbundle";
		...
		internal static void LoadAssetBundle()
		{
			...
			{
				using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("WitchMod." + assetbundleName))
				{
		...
		{
			using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("WitchMod.WitchBank.bnk"))
			{
