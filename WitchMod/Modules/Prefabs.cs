...
namespace WitchMod.Modules
{
	...
	internal static class Prefabs
	{
		...
		{
			string fullNameString = WitchPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
			string fullDescString = WitchPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
			string fullOutroString = WitchPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
			string fullFailureString = WitchPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
		...
		{
			WitchPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
			WitchPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
			WitchPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
